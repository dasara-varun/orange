...
class ProductTable extends _i1.Table<int?> {
  ProductTable({super.tableRelation}) : super(tableName: 'product') {
    ...
    sizeOrServing = _i1.ColumnString(
      'sizeOrServing',
      this,
    );
    pricePaise = _i1.ColumnInt(
      'pricePaise',
      this,
    );
    offerPricePaise = _i1.ColumnInt(
      'offerPricePaise',
      this,
    );
    ...
    customisable = _i1.ColumnBool(
      'customisable',
      this,
    );
    vegetarian = _i1.ColumnBool(
      'vegetarian',
      this,
    );
  ...
  late final _i1.ColumnString sizeOrServing;

  late final _i1.ColumnInt pricePaise;

  late final _i1.ColumnInt offerPricePaise;

  late final _i1.ColumnBool availability;

  late final _i1.ColumnBool customisable;

  late final _i1.ColumnBool vegetarian;
